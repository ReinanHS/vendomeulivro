                    ...
                    <div class="cart">
                        ...
                        <div class="scroll-menu cart-menu-content">
                                    ...
                                    >
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-quantity">
                                                <a
                                                    v-on:click="quantidadeAction(index,'diminuir')"
                                                    title="Diminuir a quantidade"
                                                    class="item-quantity-change item-quantity-change-decrement"
                                                >
                                                    <svg
                                                        width="1em"
                                                        height="1em"
                                                ...
                                                />
                                                <a
                                                    v-on:click="quantidadeAction(index, 'aumentar')"
                                                    title="Aumentar a quantidade"
                                                    class="item-quantity-change item-quantity-change-increment"
                                                >
                                                    <svg
                                                        width="1em"
                                                        height="1em"
                                            ...
                                            <div class="item-price">
                                                <div class="cart-price ml-3">
                                                    <span
                                                        class="item-price-top"
                                                    >Unidade R$ {{ item.price }}</span>
                                                    <span class="item-price-buttom">
                                                        <span>Total R$</span>
                                                        {{ getSubTotalItem(item.price, item.quantidade) }}
                                                    </span>
                                                </div>
                                                <div class="item-remove">
                                                    <a
                                                        class="item-remove-text"
                                                        v-on:click="updateData(item)"
                                                    >Excluir</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="empty-cart" v-else>
                                ...
                                <p
                                    class="text-dark"
                                >Para continuar comprando, navegue pelas categorias do site ou faça uma busca pelo seu produto.</p>
                            </div>
                        </div>
                    </div>
                </transition>
...
.cart-menu {
    ...
    @media (max-width: 576px) {
        .cart {
            ...
            .cart-menu-content .content-cart .cart-items .cart-item {
                flex-wrap: wrap;
                justify-content: center;
